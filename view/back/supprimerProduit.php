...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!empty($produit['image']) && file_exists(UPLOAD_DIR.$produit['image'])) unlink(UPLOAD_DIR.$produit['image']);
...
<div class="page-body">
  <div class="confirm-card">
    ...
    <p>Are you sure you want to delete <strong><?= htmlspecialchars($produit['nom']) ?></strong>? This action cannot be undone.</p>
