...
// Si un ID de catégorie est fourni, afficher les produits de cette catégorie
$idCategorie = (int) ($_GET['id'] ?? 0);

if ($idCategorie > 0) {
    // Mode: Afficher les produits d'une catégorie
    ...
    // Mode: Afficher toutes les catégories
        ...
        <div class="row g-4">
            <?php foreach ($categories as $categorie): ?>
                ...
                <div class="col-md-4 col-sm-6">
                    <a href="categories.php?id=<?= (int) $categorie['id_categorie'] ?>" class="text-decoration-none">
