  ...
  <header class="bo-header sticky-top">
    <div class="container d-flex align-items-center justify-content-between flex-wrap gap-2">
      <h1 class="sitename mb-0 d-flex align-items-center gap-2">
        <img src="../assets/img/logo-smp.jpg" alt="SmartMealPlanner logo" style="height:40px;width:auto;">
        <span style="font-size:1.5rem;">SmartMealPlanner</span><span style="opacity:.6"> Admin</span>
      </h1>
  ...
  <main class="container">
    <div class="bo-meals-layout">
      ...
      <section class="bo-panel" aria-labelledby="bo-list-title">
        ...
        <p class="small text-muted mb-2 d-none" id="bo-load-error">Could not load meals. Ensure PHP is running and <code>meals_list.php</code> is reachable.</p>
