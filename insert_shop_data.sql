...
-- 3 catégories + 35 produits avec images Unsplash
-- ============================================================

-- Vider les anciennes catégories et produits
DELETE FROM produit;
...
-- ============================================================
-- PRODUITS UNITAIRES (id_categorie = 1) — 15 produits
-- ============================================================
INSERT INTO produit (nom, description, prix, quantiteStock, estDurable, dateExpiration, image, statut, id_categorie) VALUES
...
-- ============================================================
-- PACKS INTELLIGENTS (id_categorie = 2) — 10 produits
-- ============================================================
INSERT INTO produit (nom, description, prix, quantiteStock, estDurable, dateExpiration, image, statut, id_categorie) VALUES
...
-- ============================================================
-- MEAL PREP PACKS (id_categorie = 3) — 10 produits
-- ============================================================
INSERT INTO produit (nom, description, prix, quantiteStock, estDurable, dateExpiration, image, statut, id_categorie) VALUES
