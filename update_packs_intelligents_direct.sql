-- ============================================================
-- Mise à jour des Packs Intelligents — version directe
-- Coller dans phpMyAdmin > onglet SQL et exécuter
-- ============================================================

UPDATE produit SET
  nom = 'Pack Fruits Rouges',
  description = 'Fraises (250g) · Framboises (150g) · Myrtilles (150g) · Cerises (200g) · Groseilles (100g) — 5 fruits rouges de saison, riches en antioxydants et vitamine C.',
  prix = 11.90
WHERE nom = 'Pack Fruits Rouges';
...
UPDATE produit SET
  ...
  prix = 9.90
WHERE nom = 'Pack Légumes Verts';

UPDATE produit SET
  nom = 'Pack Protéines Maigres',
  description = 'Filet de poulet (300g) · Thon en boîte (2×160g) · Œufs bio (×6) · Blanc de dinde (200g) · Fromage blanc 0% (250g) — 5 sources de protéines maigres pour sportifs et actifs.',
  prix = 21.90
WHERE nom = 'Pack Protéines Maigres';
...
UPDATE produit SET
  ...
  prix = 14.90
WHERE nom = 'Pack Céréales Complètes';
...
UPDATE produit SET
  ...
  prix = 13.90
WHERE nom = 'Pack Snack Healthy';

UPDATE produit SET
  nom = 'Pack Salade Repas',
  description = 'Roquette (100g) · Tomates cerises (200g) · Avocat (1 pc) · Feta (100g) · Graines de tournesol (50g) · Olives noires (80g) · Vinaigrette balsamique — tout pour une salade repas en 5 minutes.',
  prix = 12.50
WHERE nom = 'Pack Salade Complète';
...
UPDATE produit SET
  ...
  prix = 17.90
WHERE nom = 'Pack Anti-Inflammatoire';
